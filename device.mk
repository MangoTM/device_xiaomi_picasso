...
#PRODUCT_COPY_FILES += \
    $(call find-copy-subdir-files,*,$(LOCAL_PATH)/perf,$(TARGET_COPY_OUT_VENDOR)/perf)
...
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/configs/mcd_default.conf:$(TARGET_COPY_OUT_SYSTEM)/etc/mcd_default.conf
